...
$('#followingcount').click(function () {
  ...
  $.ajax({
    ...
    .done(function (data) {
      console.log(data.followingList.length);
          ...
          .prepend(`<div class="twPc-div col-md-4 col-sm-6 col-xm-12">
           <a class="twPc-bg twPc-block" style="width=100%;background : url('/images/cover.jpg')"></a><div>
             <div class="twPc-button" >
              <a href="/showFriendProfile/`+data.followingList[i].following+`?id=` + data.followingList[i].following + `" class="twitter-follow-button" data-show-count="false" data-size="large" data-show-screen-name="false" data-dnt="true">@` + data.followingList[i].following + `</a>
             </div>
